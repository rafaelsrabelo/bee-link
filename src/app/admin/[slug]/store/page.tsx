            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <div 
                    className="h-32 rounded-lg mb-4 flex items-center justify-center text-white font-bold text-lg"
                    style={{ 
                  ...
                  <div className="text-sm text-gray-600">
                    <p>Cor primária: {formData.colors.primary}</p>
                    <p>Cor secundária: {formData.colors.secondary}</p>
                    <p>Cor de destaque: {formData.colors.accent}</p>
                  </div>
                </div>
              </div>
            </div>
