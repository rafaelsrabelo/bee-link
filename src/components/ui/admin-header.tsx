...
export default function AdminHeader({ store, currentPage, title, subtitle, icon: Icon }: AdminHeaderProps) {
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-purple-100 text-sm sm:text-base">{subtitle}</p>
            </div>
          </div>
